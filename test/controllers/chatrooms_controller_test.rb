...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { description: @chatroom.description, geo_coords: @chatroom.geo_coords, name: @chatroom.name, time_dur: @chatroom.time_dur, user_id: @chatroom.user_id } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { description: @chatroom.description, geo_coords: @chatroom.geo_coords, name: @chatroom.name, time_dur: @chatroom.time_dur, user_id: @chatroom.user_id } }
